                    ...
                    <div class="row form-group">
                        <div class="col-md-12 col-md-offset-0">
                            <?php $form = ActiveForm::begin(
                                ['method' => 'get',
                                    'action' => Url::to(['report/subscriber-activity-type']),]
                            ); ?>
                    ...
                    <?php if ($dataProvider) { ?>
                        ...
                        $gridColumns = [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    /**  @var $model \common\models\SubscriberActivityType */
                                    return $model->weather + $model->tuvansudungphanbon + $model->biendoikhihau + $model->nongnghiepthongminh
                                        + $model->tracuusuco + $model->qa + $model->gap_disease + $model->price + $model->gap + $model->buy;
                                },
//                                'pageSummary' => true,
                            ],
                            [
...
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ...
                            [
                                'class' => '\kartik\grid\DataColumn',
                                'attribute' => 'gap_disease',
                                'value' => function ($model) {
                                    /**  @var $model \common\models\SubscriberActivityType */
                                    return $model->gap_disease;
                                },
                                'pageSummary' => true,
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ],
...
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ...
                            [
                                'class' => '\kartik\grid\DataColumn',
                                'attribute' => 'tracuusuco',
                                'value' => function ($model) {
                                    /**  @var $model \common\models\SubscriberActivityType */
                                    return $model->tracuusuco;
                                },
                                'pageSummary' => true,
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ],
                            [
                                'class' => '\kartik\grid\DataColumn',
                                'attribute' => 'nongnghiepthongminh',
                                'value' => function ($model) {
                                    /**  @var $model \common\models\SubscriberActivityType */
                                    return $model->nongnghiepthongminh;
                                },
                                'pageSummary' => true,
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ],
                            [
                                'class' => '\kartik\grid\DataColumn',
                                'attribute' => 'biendoikhihau',
                                'value' => function ($model) {
                                    /**  @var $model \common\models\SubscriberActivityType */
                                    return $model->biendoikhihau;
                                },
                                'pageSummary' => true,
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ],
                            [
                                'class' => '\kartik\grid\DataColumn',
                                'attribute' => 'tuvansudungphanbon',
                                'value' => function ($model) {
                                    /**  @var $model \common\models\SubscriberActivityType */
                                    return $model->tuvansudungphanbon;
                                },
                                'pageSummary' => true,
//                                                        'pageSummary' => $dataProvider->query->sum('via_site_daily')?$dataProvider->query->sum('via_site_daily'):0
                            ],
