...
$publishStatus = \common\models\Product::STATUS_PENDING;
$unPublishStatus = \common\models\Product::STATUS_INACTIVE;
$showStatus = \common\models\Product::STATUS_ACTIVE;
$deleteStatus = \common\models\Product::STATUS_DELETE;
?>


<?php
$updateLink = \yii\helpers\Url::to(['product/update-status-content']);
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs font-green-sharp"></i>
                    <span
                        class="caption-subject font-green-sharp bold uppercase"><?= Yii::t('app','Danh sách sản phẩm') ?> </span>
                </div>
                <div class="tools">
                    <a href="javascript:;" class="collapse">
                    </a>
            ...
            <div class="portlet-body">
                <p>
                    <?php echo Html::a('Tạo ', Yii::$app->urlManager->createUrl(['product/create']), ['class' => 'btn btn-success']) ?>
                </p>
                <?php
                $gridColumn = [
                    [
                    ...
                    [
                        ...
                        'editableOptions' => function ($model, $key, $index) {
                            return [
                                ...
                                'size' => 'md',
                                'displayValueConfig' => \common\models\Product::getListStatus('filter'),
                                'inputType' => \kartik\editable\Editable::INPUT_DROPDOWN_LIST,
                                'data' => \common\models\Product::getListStatus('filter'),
                        ...
                        'filter' => \common\models\Product::getListStatus('filter'),
                        'filterWidgetOptions' => [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model) {
                            return Html::a('<span class="glyphicon glyphicon-trash"></span>',
                                Yii::$app->urlManager->createUrl(['product/delete', 'id' => $model->id]), [
                ...
                <?= GridView::widget([
                    ...
                    'panel' => [
                        ...
                        'heading' => Yii::t('app','Danh sách sản phẩm')
                    ],
                    'toolbar' => [
                        [
                            'content' =>
