...
/* @var $searchModel common\models\SpecialGapAdviceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '' . \Yii::t('app', 'Quản lý khuyến cáo thông minh');
    ...
    <div class="col-md-12">
        <div class="portlet light">
            ...
            <div class="portlet-body">
                <p><?= Html::a('' . \Yii::t('app', 'Tạo khuyến cáo thông minh'), ['create'], ['class' => 'btn btn-success']) ?> </p>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 */
                                $action = "special-gap-advice/view";
                                $res = Html::a('<kbd>' . $model->tag . '</kbd>', [$action, 'id' => $model->id]);
                                return $res;
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                /** @var $model \common\models\SpecialGapAdvice */
                                return $model->is_question ? 'Là câu hỏi' : 'Không là câu hỏi';
                            },
                        ],
                        [
                            'class' => '\kartik\grid\DataColumn',
                            ...
                            'filter' => \common\models\SpecialGapAdvice::getFruits(),
                            'filterWidgetOptions' => [
...
//                'width'=>'180px',
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 * @var $model \common\models\SpecialGapAdvice
                                 */
                                if ($model->status == SpecialGapAdvice::STATUS_ACTIVE) {
                            ...
                            'filter' => SpecialGapAdvice::listStatus(),
                            'filterType' => GridView::FILTER_SELECT2,
                            'filterWidgetOptions' => [
                                'pluginOptions' => ['allowClear' => true],
                            ],
                        ...
                        ['class' => 'kartik\grid\ActionColumn',
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Url::toRoute(['special-gap-advice/view', 'id' => $model->id]), [
