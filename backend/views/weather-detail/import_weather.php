...
$this->title = Yii::t('app', 'Import thời tiết');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Thời tiết'), 'url' => ['index']];
    ...
    <div class="col-md-offset-2 col-md-8">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i><?=Yii::t("app","Import thời tiết")?>
                </div>
            </div>
                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-10 text-right">
                            <?= Html::a(Yii::t('app',"Tải file mẫu"), $model->getTemplateFileWeather()) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
