...
$this->title = '' . \Yii::t('app', 'Quản lý gói cước');
    ...
    <div class="col-md-12">
        <div class="portlet light">
            ...
            <div class="portlet-body">
                <p><?= Html::a('' . \Yii::t('app', 'Tạo gói cước'), ['create'], ['class' => 'btn btn-success']) ?> </p>
...
//                'width'=>'180px',
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 * @var $model \common\models\Service
                                 */
                                if ($model->status == Service::STATUS_ACTIVE) {
                        ...
                        ['class' => 'kartik\grid\ActionColumn',
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Url::toRoute(['service/view', 'id' => $model->id]), [
