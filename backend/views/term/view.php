...
$this->title = 'Quy định';
$this->params['breadcrumbs'][] = ['label' => Yii::t("app","Quy định"), 'url' => ['index']];
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase"><?=Yii::t("app","Thông tin chi tiết ")?><?= $model->id ?>"</span>
                </div>
                <div class="tools">
