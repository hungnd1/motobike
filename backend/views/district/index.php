...
$this->title = Yii::t('app', 'Danh sách huyện ');
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span
                        class="caption-subject font-green-sharp bold uppercase"><?= Yii::t('app', 'Danh sách huyện') ?> </span>
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <p>
                    <?php echo Html::a('Thêm mới ', Yii::$app->urlManager->createUrl(['district/create']), ['class' => 'btn btn-success']) ?>
                </p>
                <?php
                $gridColumn = [
                    [
                    ...
                    [
                        ...
                        'value' => function ($model, $key, $index, $widget) {
                            /** @var $model \common\models\District */
                            return District::getProvinceDetail($model->province_id);
                        },
                        'width' => '150px',
                        'filterType' => GridView::FILTER_SELECT2,
                        'filter' => District::getListProvince(),
                        'filterWidgetOptions' => [
