...
//        '@cat_image' => 'news',
    ...
    'components' => [
        'user' => [
            ...
            'enableSession' => false, //default false
        ],
        'log' => [
        ...
        'urlManager' => [
            'enablePrettyUrl' => true, /** Sửa cái này phải notify cho group */
...
//                'GET content/<content_id:\d>' => 'content/detail',
        ...
        'response' => [
            ...
            'on beforeSend' => function ($event) {
                ...
                $raw = isset(Yii::$app->params['response_raw']) ? Yii::$app->params['response_raw'] : false;
