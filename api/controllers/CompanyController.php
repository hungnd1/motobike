...
//        }
        ...
        $form->congLamCoDong = isset($formAnalyst['congLamCoDong']) ? str_replace(".","",$formAnalyst['congLamCoDong']) : 0;
...
//        }
        ...
        $form->congTaoHinhDong = isset($formAnalyst['congTaoHinhDong']) ? str_replace(".","",$formAnalyst['congTaoHinhDong']) : 0;
...
//        }
        ...
        $form->congBonPhanDong = isset($formAnalyst['congBonPhanDong']) ? str_replace(".","",$formAnalyst['congBonPhanDong']) : 0;
...
//        }
        ...
        $form->congThuHaiDong = isset($formAnalyst['congThuHaiDong']) ? str_replace(".","",$formAnalyst['congThuHaiDong']) : 0;
...
//        }
        ...
        $form->congSoCheDong = isset($formAnalyst['congSoCheDong']) ? str_replace(".","",$formAnalyst['congSoCheDong']) : 0;
...
//        }
        ...
        $form->congTuoiDong = isset($formAnalyst['congTuoiDong']) ? str_replace(".","",$formAnalyst['congTuoiDong']) : 0;
...
//        }
        ...
        $form->congPhunThuocDong = isset($formAnalyst['congPhunThuocDong']) ? str_replace(".","",$formAnalyst['congPhunThuocDong']) : 0;
...
//        }
        ...
        $form->congKhacDong = isset($formAnalyst['congKhacDong']) ? str_replace(".","",$formAnalyst['congKhacDong']) : 0;
...
//        }
        ...
        $form->thuocsauDong = isset($formAnalyst['thuocsauDong']) ? str_replace(".","",$formAnalyst['thuocsauDong']) : 0;
...
//        }
        ...
        $form->thuocBenhDong = isset($formAnalyst['thuocBenhDong']) ? str_replace(".","",$formAnalyst['thuocBenhDong']) : 0;
...
//        }
        ...
        $form->phanBonLaDong = isset($formAnalyst['phanBonLaDong']) ? str_replace(".","",$formAnalyst['phanBonLaDong']) : 0;
...
//        }
        ...
        $form->phanHuuCoDong = isset($formAnalyst['phanHuuCoDong']) ? str_replace(".","",$formAnalyst['phanHuuCoDong']) : 0;
...
//        }
        ...
        $form->voiNongNghiepDong = isset($formAnalyst['voiNongNghiepDong']) ? str_replace(".","",$formAnalyst['voiNongNghiepDong']) : 0;
...
//        }
        ...
        $form->phanViSinhDong = isset($formAnalyst['phanViSinhDong']) ? str_replace(".","",$formAnalyst['phanViSinhDong']) : 0;
...
//        }
        ...
        $form->phanDamSaDong = isset($formAnalyst['phanDamSaDong']) ? str_replace(".","",$formAnalyst['phanDamSaDong']) : 0;
...
//        }
        ...
        $form->phanDamUreDong = isset($formAnalyst['phanDamUreDong']) ? str_replace(".","",$formAnalyst['phanDamUreDong']) : 0;
...
//        }
        ...
        $form->phanLanDong = isset($formAnalyst['phanLanDong']) ? str_replace(".","",$formAnalyst['phanLanDong']) : 0;
...
//        }
        ...
        $form->phanKaliDong = isset($formAnalyst['phanKaliDong']) ? str_replace(".","",$formAnalyst['phanKaliDong']) : 0;
...
//        }
        ...
        $form->phanHonHop1Dong = isset($formAnalyst['phanHonHop1Dong']) ? str_replace(".","",$formAnalyst['phanHonHop1Dong']) : 0;
...
//        }
        ...
        $form->phanHonHop2Dong = isset($formAnalyst['phanHonHop2Dong']) ? str_replace(".","",$formAnalyst['phanHonHop2Dong']) : 0;
...
//        }
        ...
        $form->laiVay = isset($formAnalyst['laiVay']) ? str_replace(".","",$formAnalyst['laiVay']) : 0;

//        if (!$form->laiVay) {
//            throw new InvalidValueException($this->replaceParam(Message::getNullValueMessage(), [Yii::t('app', 'Lãi vay')]));
//        }

        $form->khauHao = isset($formAnalyst['khauHao']) ? str_replace(".","",$formAnalyst['khauHao']) : 0;

//        if (!$form->khauHao) {
//            throw new InvalidValueException($this->replaceParam(Message::getNullValueMessage(), [Yii::t('app', 'Khấu hao')]));
//        }

        $form->nhienLieu = isset($formAnalyst['nhienLieu']) ? str_replace(".","",$formAnalyst['nhienLieu']) : 0;

//        if (!$form->nhienLieu) {
//            throw new InvalidValueException($this->replaceParam(Message::getNullValueMessage(), [Yii::t('app', 'Nhiên liệu')]));
//        }

        $form->chiPhiKhac = isset($formAnalyst['chiPhiKhac']) ? str_replace(".","",$formAnalyst['chiPhiKhac']) : 0;

//        if (!$form->chiPhiKhac) {
//            throw new InvalidValueException($this->replaceParam(Message::getNullValueMessage(), [Yii::t('app', 'Chi phí khác')]));
//        }

        $form->giaBinhQuan = isset($formAnalyst['giaBinhQuan']) ? str_replace(".","",$formAnalyst['giaBinhQuan']) : 0;

//        if (!$form->giaBinhQuan) {
//            throw new InvalidValueException($this->replaceParam(Message::getNullValueMessage(), [Yii::t('app', 'Giá bình quân')]));
//        }

        $form->sanLuongTan = isset($formAnalyst['sanLuongTan']) ? str_replace(".","",$formAnalyst['sanLuongTan']) : 0;

//        if (!$form->congLamCoCong) {
//            throw new InvalidValueException($this->replaceParam(Message::getNullValueMessage(), [Yii::t('app', 'Công làm cỏ')]));
//        }

        $form->thuNhapTrongSen = isset($formAnalyst['thuNhapTrongSen']) ? str_replace(".","",$formAnalyst['thuNhapTrongSen']) : 0;
...
//        }
        ...
        $reportFormAnalyst->phanBon = CUtils::numberFormat($phanBon) . " đ";
        $reportFormAnalyst->phanBonPhanTram = $tong ? round($phanBon / $tong, 2) * 100 . "%" : "0%";
        $reportFormAnalyst->tuoi = CUtils::numberFormat($tuoi) . " đ";
        $reportFormAnalyst->tuoiPhanTram = $tong ? round($tuoi / $tong, 2) * 100 . "%" : "0%";
        $reportFormAnalyst->bvtv = CUtils::numberFormat($thuocbvtv) . " đ";
