...
/**
 * This is the model class for table "special_gap_advice".
 *
 * @property integer $id
 * @property string $tag
 ...
 */
class SpecialGapAdvice extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tag','fruit_id','status'], 'required'],
            [['is_question', 'fruit_id', 'created_at', 'updated_at', 'status'], 'integer'],
            [['tag'], 'string', 'max' => 255],
        ];
    }
